...
func TestHighEvidence_UnmarshalCBOR_good_CCA_token(t *testing.T) {
	fmt.Printf("trying.. TestEvidence_UnmarshalCBOR_good_CCA_token\n")
	TestEvidence_UnmarshalCBOR_good_CCA_token(t)
}

func mustBuildValidCcaRealmClaims(t *testing.T) realm.IClaims {
	fmt.Printf("mustBuildValidCCArealmClaims\n")
	c := realm.NewClaims()
...
func mustBuildValidPlatformClaims(t *testing.T, includeOptional bool) platform.IClaims {
	fmt.Printf("mustBuildValidPlatformClaims\n")
